...
INSERT `rent` VALUE (0, 0, 1, STR_TO_DATE('15-12-2016', '%d-%m-%Y'), NULL, 300);
INSERT `rent` VALUE (1, 0, 3, STR_TO_DATE('5-01-2017', '%d-%m-%Y'), NULL, 350);
INSERT `rent` VALUE (2, 1, 2, STR_TO_DATE('5-01-2017', '%d-%m-%Y'), STR_TO_DATE('8-01-2017', '%d-%m-%Y'), 350);
INSERT `rent` VALUE (3, 3, 2, STR_TO_DATE('9-01-2017', '%d-%m-%Y'), STR_TO_DATE('11-01-2017', '%d-%m-%Y'), 350);
INSERT `rent` VALUE (4, 4, 0, STR_TO_DATE('8-01-2017', '%d-%m-%Y'), STR_TO_DATE('10-01-2017', '%d-%m-%Y'), 150);
INSERT `rent` VALUE (5, 2, 8, STR_TO_DATE('1-01-2017', '%d-%m-%Y'), STR_TO_DATE('2-01-2017', '%d-%m-%Y'), 120);
INSERT `rent` VALUE (6, 2, 8, STR_TO_DATE('3-01-2017', '%d-%m-%Y'), STR_TO_DATE('4-01-2017', '%d-%m-%Y'), 100);
INSERT `rent` VALUE (7, 2, 8, STR_TO_DATE('3-01-2017', '%d-%m-%Y'), STR_TO_DATE('4-01-2017', '%d-%m-%Y'), 200);
INSERT `rent` VALUE (8, 1, 8, STR_TO_DATE('4-01-2017', '%d-%m-%Y'), STR_TO_DATE('10-01-2017', '%d-%m-%Y'), 100);
INSERT `rent` VALUE (9, 1, 6, STR_TO_DATE('10-01-2017', '%d-%m-%Y'), NULL, 300);